      SUBROUTINE BLDC9                                                   BLDC9  
C                                                                        BLDC9  
C ********************************************************************** BLDC9  
C *                                                                    * BLDC9  
C *********************  D E S C R I P T I O N  ************************ BLDC9  
C *                                                                    * BLDC9  
C ********************************************************************** BLDC9  
C                                                                        BLDC9  
C     SUBROUTINE BLDC9                                                   BLDC9  
C                                                                        BLDC9  
C ********************************************************************** BLDC9  
C *                                                                    * BLDC9  
C ***************************  S T A T U S  **************************** BLDC9  
...
C ********************************************************************** BLDC9  
C                                                                        BLDC9  
C      ORIGINAL AUTHOR        : MCLAIN                                   BLDC9  
C      ORIGINAL VERSION DATE  : 12/28/83                                 BLDC9  
C      REVISIONS              : 12/19/84  DOCUMENTATION ADDED.           BLDC9  
C                                2/15/85  FORMAL PARAMETERS MOVED TO     BLDC9  
C                                         COMMON  BLOCKS.                BLDC9  
C                                                                        BLDC9  
C ********************************************************************** BLDC9  
C *                                                                    * BLDC9  
C ********************  D E C L A R A T I O N S  *********************** BLDC9  
C *                                                                    * BLDC9  
C ********************************************************************** BLDC9  
C                                                                        BLDC9  
C  ------------------------                                              BLDC9  
C  ---P A R A M E T E R S .                                              BLDC9  
C  ------------------------                                              BLDC9  
C                                                                        BLDC9  
...
C                                                                        BLDC9  
C  ----------------------------------                                    BLDC9  
C  ---L O C A L   V A R I A B L E S .                                    BLDC9  
C  ----------------------------------                                    BLDC9  
C                                                                        BLDC9  
      INTEGER           I                                                BLDC9  
C                                                                        BLDC9  
C  ------------------------------------                                  BLDC9  
C  ---G L O B A L   V A R I A B L E S .                                  BLDC9  
C  ------------------------------------                                  BLDC9  
C                                                                        BLDC9  
...
C                                                                        BLDC9  
C  ------------------------------                                        BLDC9  
C  ---C O M M O N   B L O C K S .                                        BLDC9  
C  ------------------------------                                        BLDC9  
C                                                                        BLDC9  
